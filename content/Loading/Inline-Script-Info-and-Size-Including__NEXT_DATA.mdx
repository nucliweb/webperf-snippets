---
title: Inline Script Info and Size Including __NEXT_DATA__
description: Analyze inline script sizes including __NEXT_DATA__ in Chrome DevTools.
---
...
function findInlineScriptsWithNextData() {
  ...
  return {
    ...
    totalByteSize: convertToKb(byteSize.NEXT_DATA_SIZE) + convertToKb(byteSize.OTHER_SIZE) + " kb",
  };
}
